                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> أختصار
                                                                        اللغة {{__('messages.'.$subCategory -> translation_lang)}} </label>
                                                                ...
                                                                @if($SuperSubCategories && $SuperSubCategories -> count() > 0)
                                                                    @foreach($SuperSubCategories as $SuperSubCategory)
                                                                        <option value="{{$SuperSubCategory -> id }}"
                                                                                @if($subCategory->parent_id == $SuperSubCategory->id  )  selected @endif>
                                        ...
                                        <ul class="nav nav-tabs">
                                            @isset($subCategory->langCategories)
                                                @foreach($subCategory->langCategories  as  $index=>$translation)
                                                    <li class="nav-item">
