...
@section('script')
    ...
    <script>
        ...
        // ######################## If have real key api map use this code (payment api key) ###########################################
        // function initAutocomplete() {
        //     map = new google.maps.Map(document.getElementById("map"), {
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA-EF_xBiUC-j1Sq04JFmMbxVLkF2fJnBg&libraries=places&callback=initAutocomplete&language=ar&
         async defer"></script>
@stop
