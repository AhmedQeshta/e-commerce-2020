        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ Request::is('admin/languages','admin/languages/*') ? 'open' : '' }}  ">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ Request::is('admin/languages/create') ? 'active' : '' }} " ><a class="menu-item" href="{{route('admin.languages.create')}}" data-i18n="nav.dash.crypto">أضافة
                            لغة جديده </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item {{ Request::is('admin/main_categories','admin/main_categories/*') ? 'open' : '' }} ">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ Request::is('admin/main_categories/create') ? 'active' : '' }}" ><a class="menu-item" href="{{route('admin.maincategories.create')}}" data-i18n="nav.dash.crypto">أضافة
                             قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item {{ Request::is('admin/sub_categories','admin/sub_categories/*') ? 'open' : '' }}  ">
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item {{ Request::is('admin/sub_categories/create') ? 'active' : '' }} " href="{{route('admin.subcategories.create')}}" data-i18n="nav.dash.crypto">أضافة
                            قسم فرعي جديد </a>
                    </li>
                </ul>
            </li>
...
{{--            <li class="nav-item {{ Request::is('admin/student','admin/student/*') ? 'open' : '' }} "><a href=""><i class="la la-male"></i>--}}
{{--                    <span class="menu-title" data-i18n="nav.dash.main">الطلاب  </span>--}}
{{--                    <span--}}
{{--                        class="badge badge badge-warning  badge-pill float-right mr-2"></span>--}}
{{--                </a>--}}
{{--                <ul class="menu-content">--}}
{{--                    <li class=" {{ Request::is('admin/student') ? 'active' : '' }}"><a class="menu-item" href=""--}}
{{--                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>--}}
{{--                    </li>--}}
{{--                    <li><a class="menu-item  {{ Request::is('admin/student/create') ? 'active' : '' }}" href="" data-i18n="nav.dash.crypto">أضافة--}}
{{--                            طالب </a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
...
{{--            <li class="nav-item {{ Request::is('admin/sentTicket','admin/sentTicket/*') ? 'open' : '' }}">--}}
{{--                <a href=""><i class="la la-male"></i>--}}
...
{{--                </a>--}}
{{--                <ul class="menu-content">--}}
{{--                    <li class=" {{ Request::is('admin/sentTicket','admin/sentTicket/*') ? 'active' : '' }} " ><a class="menu-item" href=""--}}
